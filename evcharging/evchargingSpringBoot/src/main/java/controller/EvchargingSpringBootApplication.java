...
//		System.out.println(new Time((long) (cal.getTimeInMillis() + (1.5*60*60*1000))));
//		cal.setTime(new Time((long) (cal.getTimeInMillis() + (1.5*60*60*1000))));
//		System.out.println(cal.getTime());
...
//					java.util.Date dt_end = new java.util.Date(cal.getTimeInMillis());
//					System.out.println(cal.getTime());
//					System.out.println(dt_end.getHours());
